package org.ehealth.rx.config;

import java.util.List;

import org.ehealth.rx.client.AuthClient;
import org.ehealth.rx.domain.dto.auth.UserDto;
import org.ehealth.rx.util.annotation.CurrentUser;
