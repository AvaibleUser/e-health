...
public class PatientSurgeriesController {
    ...
    public void addSurgery(@RequestBody @Valid AddSurgeryDto surgery, @PathVariable long patientId) {
        surgeryService.addSurgery(patientId, surgery);
    }

    @PutMapping("/{surgeryId}")
    @ResponseStatus(NO_CONTENT)
    public void updateSurgery(@RequestBody @Valid UpdateSurgeryDto surgery, @PathVariable long surgeryId,
